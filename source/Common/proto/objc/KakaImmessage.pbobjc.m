  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "userAccount",
        .dataTypeSpecific.className = NULL,
        .number = BuildingRelationshipRequestMessage_FieldNumber_UserAccount,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(BuildingRelationshipRequestMessage__storage_, userAccount),
        .flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
      {
...
#if !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    static const char *extraTextFormatInfo =
        "\004\001\010A\000\002\016\000\003\013\000\004\010A\000";
    [localDescriptor setupExtraTextInfo:extraTextFormatInfo];
#endif  // !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescriptionWithDefault fields[] = {
      ...
      },
      {
        ...
        .core.name = "userAccount",
        .core.dataTypeSpecific.className = NULL,
        .core.number = BuildingRelationshipAnswerMessage_FieldNumber_UserAccount,
        .core.hasIndex = 1,
        .core.offset = (uint32_t)offsetof(BuildingRelationshipAnswerMessage__storage_, userAccount),
        .core.flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .core.dataType = GPBDataTypeString,
      },
      {
...
#if !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    static const char *extraTextFormatInfo =
        "\004\001\010A\000\002\013\000\003\016\000\005\010A\000";
    [localDescriptor setupExtraTextInfo:extraTextFormatInfo];
#endif  // !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "userAccount",
        .dataTypeSpecific.className = NULL,
        .number = DestroyingRelationshipRequestMessage_FieldNumber_UserAccount,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(DestroyingRelationshipRequestMessage__storage_, userAccount),
        .flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
    };
...
#if !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    static const char *extraTextFormatInfo =
        "\003\001\010A\000\002\016\000\003\013\000";
    [localDescriptor setupExtraTextInfo:extraTextFormatInfo];
#endif  // !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescriptionWithDefault fields[] = {
      ...
      },
      {
        ...
        .core.name = "userAccount",
        .core.dataTypeSpecific.className = NULL,
        .core.number = DestoryingRelationshipResponseMessage_FieldNumber_UserAccount,
        .core.hasIndex = 2,
        .core.offset = (uint32_t)offsetof(DestoryingRelationshipResponseMessage__storage_, userAccount),
        .core.flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .core.dataType = GPBDataTypeString,
      },
      {
    ...
    static GPBMessageFieldDescription fields[] = {
      {
        .name = "itemCount",
        .dataTypeSpecific.className = NULL,
        .number = FriendList_FieldNumber_ItemCount,
        .hasIndex = 0,
        .offset = (uint32_t)offsetof(FriendList__storage_, itemCount),
        .flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
...
@dynamic hasReceiverId, receiverId;
  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        .name = "senderId",
        .dataTypeSpecific.className = NULL,
        .number = ChatMessage_FieldNumber_SenderId,
        .hasIndex = 1,
        .offset = (uint32_t)offsetof(ChatMessage__storage_, senderId),
        .flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
      {
        .name = "receiverId",
        .dataTypeSpecific.className = NULL,
        .number = ChatMessage_FieldNumber_ReceiverId,
        .hasIndex = 2,
        .offset = (uint32_t)offsetof(ChatMessage__storage_, receiverId),
        .flags = (GPBFieldFlags)(GPBFieldRequired | GPBFieldTextFormatNameCustom),
        .dataType = GPBDataTypeString,
      },
      {
...
#if !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    static const char *extraTextFormatInfo =
        "\004\001\010A\000\002\007A\000\003\tA\000\006\010A\000";
    [localDescriptor setupExtraTextInfo:extraTextFormatInfo];
#endif  // !GPBOBJC_SKIP_MESSAGE_TEXTFORMAT_EXTRAS
    NSAssert(descriptor == nil, @"Startup recursed!");
    descriptor = localDescriptor;
