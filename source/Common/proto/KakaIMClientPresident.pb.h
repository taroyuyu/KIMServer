...
#ifndef PROTOBUF_KakaIMClientPresident_2eproto_INCLUDED
#define PROTOBUF_KakaIMClientPresident_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::kakaIM::president::NodeInfo* Arena::Create< ::kakaIM::president::NodeInfo>(Arena*);
template<> ::kakaIM::president::RequestNodeMessage* Arena::Create< ::kakaIM::president::RequestNodeMessage>(Arena*);
template<> ::kakaIM::president::ResponseNodeMessage* Arena::Create< ::kakaIM::president::ResponseNodeMessage>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace kakaIM {
namespace president {
...
class RequestNodeMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kakaIM.president.RequestNodeMessage) */ {
 public:
  ...
  inline RequestNodeMessage* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<RequestNodeMessage>(NULL);
  }

  RequestNodeMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<RequestNodeMessage>(arena);
  }
...
class NodeInfo : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kakaIM.president.NodeInfo) */ {
 public:
  ...
  inline NodeInfo* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<NodeInfo>(NULL);
  }

  NodeInfo* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<NodeInfo>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class ResponseNodeMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:kakaIM.president.ResponseNodeMessage) */ {
 public:
  ...
  inline ResponseNodeMessage* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ResponseNodeMessage>(NULL);
  }

  ResponseNodeMessage* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ResponseNodeMessage>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
#endif  // PROTOBUF_KakaIMClientPresident_2eproto_INCLUDED
