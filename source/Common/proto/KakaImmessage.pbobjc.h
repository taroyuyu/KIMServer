...
typedef GPB_ENUM(MessageIDVersion_FieldNumber) {
  MessageIDVersion_FieldNumber_Year = 1,
  MessageIDVersion_FieldNumber_Month = 2,
  MessageIDVersion_FieldNumber_Day = 3,
  MessageIDVersion_FieldNumber_Hour = 4,
  MessageIDVersion_FieldNumber_Miniute = 5,
  MessageIDVersion_FieldNumber_Second = 6,
};

@interface MessageIDVersion : GPBMessage
...
@property(nonatomic, readwrite) int32_t miniute;

@property(nonatomic, readwrite) BOOL hasMiniute;
@property(nonatomic, readwrite) int32_t second;
...
typedef GPB_ENUM(BuildingRelationshipRequestMessage_FieldNumber) {
  ...
  BuildingRelationshipRequestMessage_FieldNumber_TargetAccount = 3,
  BuildingRelationshipRequestMessage_FieldNumber_MessageId = 4,
  BuildingRelationshipRequestMessage_FieldNumber_MessageIdversion = 5,
};
...
/** 消息ID版本 */
@property(nonatomic, readwrite, strong, null_resettable) MessageIDVersion *messageIdversion;
/** Test to see if @c messageIdversion has been set. */
@property(nonatomic, readwrite) BOOL hasMessageIdversion;
...
typedef GPB_ENUM(BuildingRelationshipAnswerMessage_FieldNumber) {
  ...
  BuildingRelationshipAnswerMessage_FieldNumber_TargetAccount = 2,
  ...
  BuildingRelationshipAnswerMessage_FieldNumber_MessageIdversion = 6,
};
...
typedef GPB_ENUM(DestroyingRelationshipRequestMessage_FieldNumber) {
  ...
  DestroyingRelationshipRequestMessage_FieldNumber_TargetAccount = 3,
};
...
typedef GPB_ENUM(DestoryingRelationshipResponseMessage_FieldNumber) {
  ...
  DestoryingRelationshipResponseMessage_FieldNumber_TargetAccount = 3,
...
typedef GPB_ENUM(ChatMessage_FieldNumber) {
  ...
  ChatMessage_FieldNumber_SenderAccount = 2,
  ChatMessage_FieldNumber_ReceiverAccount = 3,
  ChatMessage_FieldNumber_Content = 4,
  ChatMessage_FieldNumber_Timestamp = 5,
  ChatMessage_FieldNumber_MessageId = 6,
  ChatMessage_FieldNumber_MessageIdversion = 7,
};
...
typedef GPB_ENUM(NotificationMessage_FieldNumber) {
  ...
  NotificationMessage_FieldNumber_MessageIdversion = 3,
};
...
typedef GPB_ENUM(PullOfflineMessage_FieldNumber) {
  ...
  PullOfflineMessage_FieldNumber_MessageIdversion = 5,
};
