...
namespace kakaIM {
    namespace node {
        ...
        void
        SingleChatModule::addVideoChatRequestMessage(std::unique_ptr<kakaIM::Node::VideoChatRequestMessage> message,
                                                     const std::string connectionIdentifier) {
            if (!message) {
                return;
            }
        ...
        void SingleChatModule::addVideoChatRequestCancelMessage(
                std::unique_ptr<kakaIM::Node::VideoChatRequestCancelMessage> message,
                const std::string connectionIdentifier) {
            if (!message) {
                return;
            }
        ...
        void SingleChatModule::addVideoChatCandidateAddressMessage(
                std::unique_ptr<kakaIM::Node::VideoChatCandidateAddressMessage> message,
                const std::string connectionIdentifier) {
            if (!message) {
                return;
            }
